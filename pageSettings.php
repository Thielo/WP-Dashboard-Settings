<?php
	/*
		Plugin Name: Page Settings by Richard Thiel
		Description: Little Plugin to create simple Settingsoptions in the Dashboard
		Version: 0.1
		Author: Richard Thiel
		Author URI: www.richardthiel.de
	*/

  add_action('wp_dashboard_setup', array('pageSettings','init') );
  wp_enqueue_style('simpleseo-css',plugins_url('/pageSettings.css', __FILE__));
class pageSettings {

    /**
     * The id of this widget.
     */
    const wid = 'pageSettings';
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            array('pageSettings','widget'),      //Callback for the main widget content
            array('pageSettings','config')       //Optional callback for widget configuration content
        );
    }
    ...
    public static function widget() {
        require_once( 'pageSettings-widget.php' );
    }
    ...
    public static function config() {
        require_once( 'pageSettings-widget-config.php' );
    }
